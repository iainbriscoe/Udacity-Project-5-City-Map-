...
function viewModel(){
	...
	this.searchList = function(model){
		var currentVal = $('.search-location-field').val();
		places = model;

		if(currentVal === "") { 
			console.log("test"); 
			self.list = ko.observableArray(model.Places);
		}
		else {
...
$(document).ready(function() {
	...
	self.searchList = new searchList(mapDataViewmodel.Places());
});
